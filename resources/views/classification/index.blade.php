                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">{{trans('main.classifications')}}</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="btn-group">
                                                <a href="{{ route('classifications.create') }}" id="sample_editable_1_new"
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                "bInfo": false,
                ajax: {
                    url: '{{url("/classifications/contentListData")}}',
                    type: 'POST',
                    'headers': {
            ...
            $('#data-table').on('change', '.btnToggle input[type="radio"]', function () {
                ...
                $.ajax({
                    url: "{{url('classification_activate')}}",
                    method: "get",
