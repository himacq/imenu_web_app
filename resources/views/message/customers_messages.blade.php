                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">{{trans('messages.customers_messages')}}</span>
                                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                "bInfo": false,
                ajax: {
                    url: '{{url("/messages/customerMessagesContentListData")}}',
                    type: 'POST',
                    'headers': {
                ...
                columns: [
                    ...
                    {data: 'sender',width:"20%" ,name: 'sender', 'class': 'name'},
