...
@section('content')
    <form id='form-data' action="{{ url('reports/orders') }}" method="post" >
    @csrf
    <!-- Main Content -->
                        ...
                        @if(!(empty($reportData)))
                            ...
                            @foreach($reportData as $data)
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->status->last()->status_text->translate('display_text')}}</td>
                ...
                buttons: [
                    {
                        extend: 'print',
                        footer: true,
                        title: "{{trans('reports.orders')}} {{trans('reports.from')}} {{$from}} {{trans('reports.to')}} {{$to}}"
                    },
