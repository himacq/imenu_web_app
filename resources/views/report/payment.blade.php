...
@section('content')
    <form id='form-data' action="{{ url('reports/payments') }}" method="post" >
    @csrf
    <!-- Main Content -->
                ...
                <div class="portlet-body">
                    ...
                    <table id="data-table"
                        ...
                        <tr>
                            ...
                            <th>{{trans('orders.order_restaurant_id')}}</th>
                ...
                buttons: [
                    {
                        extend: 'print',
                        footer: true,
                        title: "{{trans('reports.payments')}} {{trans('reports.from')}} {{$from}} {{trans('reports.to')}} {{$to}}"
                    },
