...
@section('content')
    <form id='form-data' action="{{ url('reports/most_ranked') }}" method="post" >
    @csrf
    <!-- Main Content -->
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase">{{trans('main.most_ranked')}}</span>
                            </div>
