...
@section('content')
    <form id='form-data' action="{{ url('reports/payments_geo') }}" method="post" >
    @csrf
    <!-- Main Content -->
                    ...
                    <table id="data-table"
                        ...
                        @if(!(empty($reportData)))
                            ...
                            @foreach($reportData as $data)
                                ...
                                <tr>
                                    <td>{{($data->distance_exceeded?trans('reports.distance_exceeded'):trans('reports.distance_not_exceeded'))}}</td>
                                    <td>{{$data->counts}}</td>
                                </tr>
                ...
                buttons: [
                    {
                        extend: 'print',
                        footer: true,
                        title: "{{trans('reports.payments_methods')}} {{trans('reports.from')}} {{$from}} {{trans('reports.to')}} {{$to}}"
                    },
