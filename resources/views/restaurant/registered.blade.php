                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">{{trans('main.registered_restaurants')}}</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                ...
                                <table id="data-table"
                                    ...
                                    <tr>
                                        ...
                                        <th>{{trans('restaurants.status')}}</th>
                                        <th>{{trans('restaurants.city')}}</th>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                "bInfo": false,
                ajax: {
                    url: '{{url("/")}}/restaurants/registeredContentListData',
                    type: 'POST',
                    'headers': {
            ...
            $('#statusFilter').on('change', function(){
                ...
                var new_url = '{{url("/")}}/restaurants/registeredContentListData/'+filter_value;
