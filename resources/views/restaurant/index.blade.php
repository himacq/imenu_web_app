                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">{{trans('main.restaurants')}}</span>
                                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                "bInfo": false,
                ajax: {
                    url: '{{url("/")}}/restaurants/contentListData',
                    type: 'POST',
                    'headers': {
            ...
            $('#statusFilter').on('change', function(){
                ...
                var new_url = '{{url("/")}}/restaurants/contentListData/'+filter_value;
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        if (active == 0) {
                            ...
                            if(selected != "") {
                                var new_url = '{{url("/")}}/restaurants/contentListData/'+1;
                                table.ajax.url(new_url).load();
                            }
                            ...
                            if(selected != "") {
                                var new_url = '{{url("/")}}/restaurants/contentListData/'+0;
                                table.ajax.url(new_url).load();
                            }
