...
@section('content')
 <form id='form-user' action="{{ route('roles.update', $role->id) }}" method="post" role="form">
                                        {{csrf_field()}}
                                        {{ method_field('PATCH') }}       
          <!-- Main Content -->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">{{trans('roles.edit_role')}}</span>
                                    </div>
                                ...
                                <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{ $role->name }}" readonly="readonly"
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" name="display_name_ar" value="{{ $role->display_name_ar  }}"
                                                       placeholder="{{trans('roles.enter_display_name')}}">
                                                <label for="form_control_1">{{trans('roles.display_name')}}
                                                <i class="fa fa-angle-left"></i>
                                                {{__('main.arabic')}}
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" name="display_name_tr" value="{{ $role->display_name_tr }}"
                                                       placeholder="{{trans('roles.enter_display_name')}}">
                                                <label for="form_control_1">{{trans('roles.display_name')}}
                                                <i class="fa fa-angle-left"></i>
                                                {{__('main.turkish')}}
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" name="description_tr" value="{{ $role->description_tr  }}"
                                                       placeholder="{{trans('roles.enter_description')}}">
                                                <label for="form_control_1">{{trans('roles.description')}}
                                                <i class="fa fa-angle-left"></i>
                                                {{__('main.turkish')}}
