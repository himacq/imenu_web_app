...
@section('content')
@if($copy)
<form id='form-data' action="{{ route('categories.store_copy') }}" method="post" enctype="multipart/form-data">
     {{csrf_field()}}
@else
 <form id='form-data' action="{{ route('categories.update', $category->id) }}" method="post" enctype="multipart/form-data">
     {{csrf_field()}}
    {{ method_field('PATCH') }}
 @endif
                <!-- Main Content -->
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" name="name_tr" value="{{ $category->name_tr }}"
                                                       placeholder="{{trans('main.enter_name')}}">
                                                <label for="form_control_1">{{trans('main.name')}}
                                                <i class="fa fa-angle-left"></i>
                                                {{__('main.turkish')}}
                                                        ...
                                                        <div class="mt-radio-inline">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="isActive" id="optionsRadios25" value="1"
                                                                       {{$category->isActive==1 ? "checked" : ""}} value="1" >{{trans('main.active')}}
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="isActive" id="optionsRadios26" value="0" 
                                                                       {{$category->isActive==0 ? "checked" : ""}} >{{trans('main.not_active')}}
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="fileinput fileinput-exists" data-provides="fileinput">
                                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px; line-height: 150px;">
                                                            <img src="{{ url('/uploads/categories/'.($category->image?$category->image:'default.jpg')) }}">
                                                        </div>
                                                        <div>
