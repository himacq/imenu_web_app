...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 red" href="{{url('users')}}">
                            <div class="visual">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 green" href="{{url('reports/most_orders')}}">
                            <div class="visual">
                            ...
                            <div class="details">
                                ...
                                <div class="desc">{{trans('main.most_orders')}}</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <a class="dashboard-stat dashboard-stat-v2 purple" href="{{url('users/users_app_reviews')}}">
                            <div class="visual">
                                <i class="fa fa-globe"></i>
                            </div>
                            <div class="details">
                                <div class="number">
                                    <span data-counter="counterup" data-value="{{$customer_reviews_count}}">0</span></div>
                                <div class="desc">{{trans('main.users_app_reviews')}}</div>
                            </div>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-dark bold uppercase">{{trans('main.users')}}</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc">
                                                                    <a href="{{url('registered-users/'.$user->id.'/edit')}}" >
                                                                    {{$user->name}}
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col2">
                                                        <div class="date"> {{date('d-m-Y', strtotime($user->created_at)) }} </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="scroller-footer">
                                    <div class="btn-arrow-link pull-right">
                                        <a href="{{url('users')}}">{{trans('main.show_all')}}</a>
                    ...
                    <div class="col-lg-6 col-xs-12 col-sm-12">
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="scroller-footer">
                                    <div class="btn-arrow-link pull-right">
                                        <a href="{{url('users/users_app_reviews')}}">{{trans('main.show_all')}}</a>
                                        <i class="icon-arrow-right"></i>
                                    </div>
                                </div>
                            </div>
